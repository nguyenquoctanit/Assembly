...
mypath1 = r'H:/QuocTan/QuocTan/best.pt'
model1 = torch.hub.load('./levu', 'custom', path=mypath1,
...
def make_window():
    ...
    Step_1 = [
        [sg.Text('Step 1: Get image in folder',
                 font='Any 20', text_color='yellow')],
        [sg.T('1.Choose folder get image             ',
              font='Any 15', text_color='orange')],
        ...
        [sg.T('2.Choose folder save image             ',
              font='Any 15', text_color='orange')],
        ...
        [sg.T('3.Enter name image you want get             ',
              font='Any 15', text_color='orange')],
        [sg.Multiline('', size=(40, 10), text_color='navy',
                      key='input_names0')],
        [sg.Button('OK', size=(12, 1), font=(
            'Helvetica', 10), key='button_names0')],
        [sg.T('4.Start get image           ', font='Any 15', text_color='orange')],
        [sg.Button('Start', size=(12, 1), font=(
            'Helvetica', 10), key='start0')],
    ]
    ...
    Step_2 = [
        ...
        [sg.Frame('',
                  [
                      [sg.Text('Step 2: Auto filter image',
                               font='Any 20', text_color='yellow')],
                      [sg.T('1.Choose file weights              ', font='Any 15', text_color='orange'),
                       sg.Input(size=(60, 1), font=('Helvetica', 12), key='input_weight1',
                                readonly=True, text_color='navy', enable_events=True),
        ...
        [sg.Frame('', [
            [sg.Text('Name', size=(15, 1), font=('Helvetica', 15), text_color='orange'),
             sg.Text('Join', size=(7, 1), font=(
                 'Helvetica', 15), text_color='orange'),
             sg.Text('OK', size=(7, 1), font=(
                 'Helvetica', 15), text_color='orange'),
             sg.Text('Num', size=(7, 1), font=(
                 'Helvetica', 15), text_color='orange'),
             sg.Text('NG', size=(8, 1), font=(
                 'Helvetica', 15), text_color='orange'),
             sg.Text('Width Min', size=(11, 1), font=(
                 'Helvetica', 15), text_color='orange'),
             sg.Text('Width Max', size=(11, 1), font=(
                 'Helvetica', 15), text_color='orange'),
             sg.Text('Height Min', size=(11, 1), font=(
                 'Helvetica', 15), text_color='orange'),
             sg.Text('Height Max', size=(9, 1), font=('Helvetica', 15), text_color='orange')],
        ], relief=sg.RELIEF_FLAT)],
        [sg.Frame('', [
            [
                sg.Text(f'{model1.names[i1]}_1', size=(15, 1), font=(
                    'Helvetica', 15), text_color='pink'),
                sg.Checkbox('', size=(5, 5), default=True, font=(
                    'Helvetica', 15),  key=f'{model1.names[i1]}_1', enable_events=True),
                sg.Checkbox('', size=(5, 5), font=('Helvetica', 15),
                            key=f'{model1.names[i1]}_OK_1', enable_events=True),
                sg.Input('1', size=(2, 1), font=('Helvetica', 15),
                         key=f'{model1.names[i1]}_Num_1', text_color='navy', enable_events=True),
                sg.Text('', size=(4, 1), font=(
                    'Helvetica', 15), text_color='red'),
                sg.Checkbox('', size=(5, 5), font=('Helvetica', 15),
                            key=f'{model1.names[i1]}_NG_1', enable_events=True),
                sg.Input('0', size=(8, 1), font=('Helvetica', 15),
                         key=f'{model1.names[i1]}_Wn_1', text_color='navy', enable_events=True),
                sg.Text('', size=(2, 1), font=(
                    'Helvetica', 15), text_color='red'),
                sg.Input('100000', size=(8, 1), font=('Helvetica', 15),
                         key=f'{model1.names[i1]}_Wx_1', text_color='navy', enable_events=True),
                sg.Text('', size=(2, 1), font=(
                    'Helvetica', 15), text_color='red'),
                sg.Input('0', size=(8, 1), font=('Helvetica', 15),
                         key=f'{model1.names[i1]}_Hn_1', text_color='navy', enable_events=True),
                sg.Text('', size=(2, 1), font=(
                    'Helvetica', 15), text_color='red'),
                sg.Input('100000', size=(8, 1), font=('Helvetica', 15),
                         key=f'{model1.names[i1]}_Hx_1', text_color='navy', enable_events=True),
            ] for i1 in range(len(model1.names))
        ], relief=sg.RELIEF_FLAT)],
        [sg.T('4.Choose folder image              ', font='Any 15', text_color='orange'),
         sg.Input(size=(60, 1), font=('Helvetica', 12), key='input_image1',
                  readonly=True, text_color='navy', enable_events=True),
         sg.FolderBrowse(size=(12, 1), font=('Helvetica', 10), key='directory_image1', enable_events=True)],
        # [sg.T('4.Choose folder model', font='Any 15', text_color = 'orange')],
        # [sg.Input(size=(35,1), font=('Helvetica',12), key='input_model1',readonly= True, text_color='navy',enable_events= True),
        ...
        [sg.T('5.Choose folder save                ', font='Any 15', text_color='orange'),
         sg.Input(size=(60, 1), font=('Helvetica', 12), key='input_save1',
                  readonly=True, text_color='navy', enable_events=True),
         sg.FolderBrowse(size=(12, 1), font=('Helvetica', 10), key='directory_save1', enable_events=True)],
        #[sg.Listbox(values=CLASSES1,size=(23,4), text_color= 'navy',select_mode= sg.LISTBOX_SELECT_MODE_MULTIPLE, key='classes1')],
        [sg.T('6.Start create auto label            ',
              font='Any 15', text_color='orange')],
        [sg.Button('Start', size=(12, 1), font=(
            'Helvetica', 10), key='start1')],
    ]
    # ,expand_x=True)]
    # ]

    Step_3 = [
        [sg.Text('Step 3: Auto create label',
                 font='Any 20', text_color='yellow')],
        [sg.T('1.Choose file weights', font='Any 15', text_color='orange')],
        ...
        [sg.T('2.Choose confident', font='Any 15', text_color='orange')],
        [sg.Slider(range=(1, 100), orientation='h', size=(48, 20), font=(
            'Helvetica', 11), default_value=25, key='input_conf2')],
        [sg.T('3.Choose folder image', font='Any 15', text_color='orange')],
        ...
        [sg.Input(size=(35, 1), font=('Helvetica', 12), key='input_save2', readonly=True, text_color='navy', enable_events=True),
         sg.FolderBrowse(size=(12, 1), font=('Helvetica', 10), key='directory_model2', enable_events=True)],
        [sg.T('5.Enter all name labels',
              font='Any 15', text_color='orange')],
        [sg.Multiline('', size=(40, 10), text_color='navy',
                      key='input_classes2')],
        [sg.Button('OK', size=(12, 1), font=(
            'Helvetica', 10), key='button_classes2')],
        #[sg.Listbox(values=CLASSES1,size=(23,4), text_color= 'navy',select_mode= sg.LISTBOX_SELECT_MODE_MULTIPLE, key='classes1')],
        [sg.T('7.Start create auto label',
              font='Any 15', text_color='orange')],
        [sg.Button('Start', size=(12, 1), font=(
            'Helvetica', 10), key='start2')],

    ]

    Step_4 = [
        [sg.Text('Step 4: Create label by program',
                 font='Any 20', text_color='yellow')],
        [sg.T('1.Enter all name labels', font='Any 15', text_color='orange')],
        [sg.Multiline('', size=(40, 10), text_color='navy',
                      key='input_classes3')],
        [sg.Button('OK', size=(12, 1), font=(
            'Helvetica', 10), key='button_classes3')],
        [sg.T('2.Open Program', font='Any 15', text_color='orange')],
        [sg.Button('Open Program', size=(12, 1), font=(
            'Helvetica', 10), key='program3')],
    ]

    Step_5 = [
        [sg.Text('Step 5: Auto split image and label',
                 font='Any 20', text_color='yellow')],
        ...
        [sg.Button('Start', size=(12, 1), font=(
            'Helvetica', 10), key='start4')],
    ]

    Step_6 = [
        [sg.Text('Step 6: Auto Training', font='Any 20', text_color='yellow')],
        [sg.T('1.Choose folder contain folder train and valid',
              font='Any 15', text_color='orange')],
        ...
        [sg.Multiline('', size=(40, 8), text_color='navy',
                      key='input_classes5')],
        [sg.Button('OK', size=(12, 1), font=(
            'Helvetica', 10), key='button_classes5')],
        ...
        [sg.Slider(range=(1, 500), orientation='h', size=(48, 20), font=(
            'Helvetica', 11), default_value=300, key='input_epoch5')],
        ...
        [sg.T('7.Line + MaHang + Camera + NgayThangNam',
              font='Any 15', text_color='orange')],
        [sg.Input(size=(35, 1), font=('Helvetica', 12),
                  key='input_name5', text_color='navy', enable_events=True)],
        # sg.FolderBrowse(size=(12,1), font=('Helvetica',10),key= 'directory_image5',enable_events=True) ],
        [sg.T('8.Start auto training', font='Any 15', text_color='orange')],
        [sg.Button('Start', size=(12, 1), font=(
            'Helvetica', 10), key='start5')],
    ...
    Step_8 = [
        ...
        [sg.Checkbox('Use training 2', size=(12, 1),
                     font=('Helvetica', 15), key='use7')],
        [sg.T('1.Choose folder contain folder train and valid',
              font='Any 17', text_color='orange')],
        ...
        [sg.Multiline('', size=(40, 8), text_color='navy',
                      key='input_classes7')],
        [sg.Button('OK', size=(12, 1), font=(
            'Helvetica', 10), key='button_classes7')],
        ...
        [sg.Slider(range=(1, 500), orientation='h', size=(48, 20), font=(
            'Helvetica', 11), default_value=300, key='input_epoch7')],
        ...
        [sg.T('7.Line + MaHang + Camera + NgayThangNam',
              font='Any 15', text_color='orange')],
        [sg.Input(size=(35, 1), font=('Helvetica', 12),
                  key='input_name7', text_color='navy', enable_events=True)],
    ...
    Step_7 = [
        ...
        [sg.T('1.Choose folder contain images and labels',
              font='Any 15', text_color='orange')],
    ...
    layout_1 = [
        [sg.Text('VDM AI VISION', font='Any 40', text_color='blue',
                 justification='center', expand_x=True, background_color='white')],
        [
    ...
    layout = [[
        sg.TabGroup([[
            sg.Tab('Page 1', layout_1,
                   background_color=BORDER_COLOR),
            sg.Tab('Page 2', layout_2,
                   background_color=BORDER_COLOR),
            sg.Tab('Page 3', layout_3,
                   background_color=BORDER_COLOR),
        ]], background_color=BORDER_COLOR, selected_background_color=BORDER_COLOR, selected_title_color='black')
    ]]
    window = sg.Window('Nguyễn Quốc Tấn', layout, margins=(
        0, 0), background_color=BORDER_COLOR, grab_anywhere=True)
    return window
                ...
                for i1 in range(len(model1.names)):
                    if values[f'{model1.names[i1]}_OK_1'] == True:
                        ...
                        if len_name1 != int(values[f'{model1.names[i1]}_Num_1']):
                            ...
                            cv2.imwrite(
                                values['input_save1'] + '/' + name_folder_ng + '.jpg', img1)
                            myresult1 = 1
                    ...
                    for item in range(len(mydetects)):
                        ...
                        for i, myclass2 in zip(range(len(myclasses2)), myclasses2):
                            if name_label == myclass2:
                                label_text = str(i)
                        f.write(label_text + " " + str(mydetect[0]) + " " + str(
                            mydetect[1]) + " " + str(mydetect[2]) + " " + str(mydetect[3]))
                        f.write("\n")
                    f.close()
    ...
    if event == 'program3':
        if values['input_classes3'] != '':
            program_dir = os.path.join(
                os.getcwd() + '/labelImg/', 'labelImg.py')
...
# 5
    if event == 'start4':
        if (values['input_image4'] != '') & (values['input_save4'] != ''):
            ...
            # random.seed(0)
            list_image_train = random.sample(
                list_image, int(len(list_image)*0.85))
...
# 6
    ...
    if event == 'move5':
        if values['input_move5'] != '':
            try:
                ...
                shutil.copytree(values['input_move5'] +
                                '/train', os.getcwd() + '/train')
                shutil.copytree(values['input_move5'] +
                                '/valid', os.getcwd() + '/valid')
            except:
                sg.popup_error('Error')
    ...
    if event == 'start5':
        if values['input_classes5'] != '' and values['input_name5'] != '' and values['input_save5'] != '':
            ...
            dir_model5 = os.path.join(
                os.getcwd() + '/levu/models/', 'levu.yaml')
            name_folder = time_to_name()
            program_dir5 = [dir_py5, ' --img ', str(values['imgsz5']), ' --batch ', '4', ' --epochs ', '{}'.format(int(values['input_epoch5'])),
                            ' --data ', dir_data5, ' --cfg ', dir_model5, ' --weights ', '""', ' --name ', 'my_results' + '{}'.format(name_folder),  ' --cache']

            subprocess.call(['python', program_dir5])
            # subprocess.Popen(program_dir5)

            shutil.copyfile(os.getcwd() + '/levu/runs/train/my_results' + name_folder +
                            '/weights/best.pt', values['input_save5'] + '/' + values['input_name5'] + '.pt')

            shutil.copyfile(os.getcwd() + '/levu/result.txt',
    ...
    if MYCOMPLETE == 1 and values['use7'] == True:
        if values['input_move7'] != '':
            try:
                ...
                if os.path.isdir(os.getcwd() + '/valid'):
                    shutil.rmtree(os.getcwd() + '/valid')
                shutil.copytree(values['input_move7'] +
                                '/train', os.getcwd() + '/train')
                shutil.copytree(values['input_move7'] +
                                '/valid', os.getcwd() + '/valid')
                button_classes = 1
    ...
    if start7 == 1:
        if values['input_classes7'] != '' and values['input_move7'] != '' and values['input_save7'] != '':
            ...
            dir_model5 = os.path.join(
                os.getcwd() + '/levu/models/', 'levu.yaml')
            name_folder = time_to_name()
            program_dir5 = [dir_py5, ' --img ', str(values['imgsz7']), ' --batch ', '4', ' --epochs ', '{}'.format(int(values['input_epoch7'])),
                            ' --data ', dir_data5, ' --cfg ', dir_model5, ' --weights ', '""', ' --name ', 'my_results' + '{}'.format(name_folder),  ' --cache']

            subprocess.call(['python', program_dir5])
            shutil.copyfile(os.getcwd() + '/levu/runs/train/my_results' + name_folder +
                            '/weights/best.pt', values['input_save7'] + '/' + values['input_name7'] + '.pt')
                    ...
                    if dir[-11:] != 'classes.txt':
                        for input_num in input_nums:
                            if input_num in nums:
                                ...
                                shutil.copy(
                                    dir[:-4] + '.jpg', values['input_move6'] + '/' + name + '.jpg')
                    if dir[-11:] == 'classes.txt':
                        shutil.copy(
                            dir, values['input_move6'] + '/' + 'classes.txt')
