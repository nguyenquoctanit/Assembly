...
#6
    ...
    if event == 'start5':
        if values['input_classes5'] != '':
            ...
            program_dir5 = [ dir_py5, ' --img ', '608', ' --batch ', '4' ,' --epochs ', '{}'.format(int(values['input_epoch5'])) , ' --data ', dir_data5 , ' --cfg ', dir_model5, ' --weights ', '""', ' --name ', 'my_results' + '{}'.format(name_folder),  ' --cache']
